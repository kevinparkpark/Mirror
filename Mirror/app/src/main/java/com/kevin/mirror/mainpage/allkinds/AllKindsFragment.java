...
public class AllKindsFragment extends BaseFragment{
    ...
    private AllKindsRecyclerViewAdapter recyclerViewAdapter;
    ...
    protected void initData() {
        recyclerViewAdapter=new AllKindsRecyclerViewAdapter(context);
        ...
        netTool.postRequest(URLValues.ALLKINDS_URL, "", "2", new NetListener() {
            ...
            public void onSuccessed(String result) {
                ...
                recyclerViewAdapter.setAllKindsBeen(allKindsBean.getData().getList());
