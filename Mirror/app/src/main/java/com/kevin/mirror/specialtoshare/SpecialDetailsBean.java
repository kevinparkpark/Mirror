...
public class SpecialDetailsBean {
    ...
    public static class DataBean {
        ...
        public static class StoryDataBean {
             ...
             * title : 去Pitti看全世界的型男
             * titleColor : ffffffff
             * subTitle : 如何看遍世界型男？去意大利佛罗伦萨就可以。  每年的一月和六月，全世界最会穿衣服的男人们都会汇聚在意大利的佛罗伦萨，一起参加一个叫Pitti Immagine Uomo的男装博览会。
             * colorTitle :
             * colorTitleColor : 6c1836ff
             * category : styleTwo
             * info_if_tag :
             * goodsname : 去Pitti看全世界的型男
             * goodsprice :
             * goodsx :
             * goodsY :
             * good_info : {"goods_id":"","goods_pic":"","model":"","goods_img":"","goods_name":"","last_storge":"","whole_storge":"","height":"","ordain":"","product_area":"","goods_price":"","discount_price":"","brand":"","info_des":"","goods_data":[{"introContent":"","cellHeight":"","name":"","location":"","country":"","english":""}],"design_des":[{"img":"","cellHeight":"","type":""}],"goods_share":"http://api.mirroreye.cn/index.php/goodweb/info?id="}
             */
